...
class FFM(nn.Module):
    ...
    # low_x: skip connection feature map, needs to be processed by residual conv block
    # high_x: prev-level feature fusion result
    # aggregate by summation
    # another residual conv block + upsample to match next-level channel num & size
